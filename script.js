document.addEventListener('DOMContentLoaded', () => {
  ...
  function processImage(file) {
    ...
    reader.onload = async (e) => {
      ...
      try {
        ...
        // Apply the mask to the original image and change background
        const processedImageUrl = await applyMaskAndChangeBackground(originalImageUrl, alphaMaskBlob, 'blue'); // 'blue' as example color
        ...
        // Fallback to local simulation if API call or mask application fails
  ...
  async function applyMaskAndChangeBackground(originalImageUrl, alphaMaskBlob, newBackgroundColor) {
